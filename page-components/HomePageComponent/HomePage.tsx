...
export const HomePage = (): JSX.Element => {
  const minHeight = 'min-h-[calc(100vh-32px-80px)]'; //32px height of header and 80px is Y axis margin
  return (
    <div className={`grid grid-cols-1 content-center ${minHeight}`}>
      ...
      <div>
        <Link href="/register/user">
          <Button
            ripple
            className="w-full md:w-[52%] hover:md:w-[55%] lg:w-[38%] hover:lg:w-[41%] xl:w-[33%] hover:xl:w-[36%] 2xl:w-[30%] hover:2xl:w-[33%]"
          >
            <span className="flex items-center justify-between">
              <span className="p-4 whitespace-nowrap select-none">
                Check out assignment
              </span>
              <span className="border-l-2 border-pink-400 hover:border-pink-900 ml-0 p-4">
